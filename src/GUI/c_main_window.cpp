...
void CMainWindow::on_btnMenu_Min_clicked()
{
    showMinimized();
}

void CMainWindow::on_btnMenu_Max_clicked()
{
...
void CMainWindow::on_btnMenu_Close_clicked()
{
    close();
}
